-- ============================================================================
-- Migration: 20260824000001_process_paystack_subscription_not_renew.sql
-- Description: Creates the atomic public.process_paystack_subscription_not_renew RPC
--              for handling verified Paystack subscription.not_renew webhook events,
--              transitioning active subscriptions to non-renewing without terminating access.
-- ============================================================================
